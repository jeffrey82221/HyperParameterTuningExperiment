...
from XORTrainerFunc import model_contruction_time  # perfect_acc_time  # initial_acc  # initial_slop
'''
pbounds = {
...
optimizer.maximize(
    ...
    init_points=2**1,  # determine according to the boundary of each parameter
)
